...
import 'package:instagram_following_list_listview_flutter_challeng_26/user.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Users you can follow', style: TextStyle(color: Colors.black),),
      ),
      body: Container(
        ...
        children: [
          ...
          Container(
            ...
            child: MaterialButton(
              elevation: 0,
              color: isFollowed? Color(0xffeeeeee): Color(0xffffffff),
              onPressed: (){
                setState(() {
